<?php /*a:1:{s:79:"D:\wamp64\www\tp\jiahoumendaima\shangcheng\application\index\view\ctrl\vip.html";i:1582938912;}*/ ?>
        ...
        $.ajax({
            ...
            success:function(coordinates){
                ...
                if (result.code == 0) {
                    ...
                    if (result.info.name2 != '' && result.info.redirect) {
                    ...
                    <p class="clear" style="padding: 5px;text-align: left;padding-left: 30px;">\
                        ...
                        <span class="zhuangtai" id="">'+result.info.master_bank+'</span>\
                            ...
                            <div class="file">\
                            <input type="file" name="" id="voucher" onchange="change2()">\
                            <img src="" alt="" class="voucher_img" style="height: 120px;min-width: 300px;">\
                            </div>\
                            </div>\
                                ';

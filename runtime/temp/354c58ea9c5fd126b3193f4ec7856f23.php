...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><meta http-equiv="X-UA-Compatible" content="ie=edge"><title>Document</title><script src="/static/plugs/jquery/jquery.min.js"></script><link rel="stylesheet" href="/public/css/style.css"><script src="/public/js/ui.js"></script><link rel="stylesheet" href="/public/css/ui.css"><script src="/public/js/common.js"></script><style>
    ...
    </style></head><body><header><div class="back" onclick="history.back(-1)"></div><span>绑定手机号</span></header><div class="container"><div class="form"><p class="form_title">登录密码:</p><div class="input_box"><input type="password" placeholder="请输入登录密码" id="pwd"></div></div><div class="form"><p class="form_title">新手机号:</p><div class="input_box"><input type="text" placeholder="请输入新手机号" id="new_tel"></div></div><div class="form verify"><p class="form_title">验证码:</p><div class="input_box"><input type="text" placeholder="请输入验证码" id="verify"></div><div class="verify_btn">获取验证码</div></div><div class="btn">确定</div></div></body><script>

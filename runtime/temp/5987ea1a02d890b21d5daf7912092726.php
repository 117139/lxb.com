        ...
        * {
        ...
        /*首页项目统计*/
             ...
             style="height:100%;width:100%;max-width: 100%;max-height: 100%;max-height:100px"><div class="ggnotice-html"><p style="margin-left:0cm; margin-right:0cm; text-align:center"><span
                ...
                ?></p><p><a class="page_index_ckxxnr" href="/index/support/detail/6.html?id=6">查看详细内容 </a></p></div><img src="/public/img/close_notice.png" class="close-img"></div></div><div class="hui-wrap"><div class="container" style="margin-top:0px;padding-bottom: 5px"><!-- 轮播图 --><div class="swiper-container "><div class="swiper-wrapper "><?php if($banner): if(is_array($banner) || $banner instanceof \think\Collection || $banner instanceof \think\Paginator): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><a href="<?php echo htmlentities($vo['url']); ?>"><img src="<?php echo htmlentities($vo['image']); ?>" alt="/public/img/bg.jpg"></a></div><?php endforeach; endif; else: echo "" ;endif; else: ?><?php endif; ?></div><div class="swiper-pagination"></div></div></div><div style="background:#FFF; padding:0px 15px; margin:10px;" class="hui-flex"><div style="height:46px; width:20px;"><img src="http://127.0.0.27/statics/img/spiker.png" width="20" style="padding:13px 0px;"></div><div class="hui-scroll-news" id="scrollnew1"><div class="hui-scroll-news-items hui-scroll-news-h0">恭喜用户181****8896获得佣金0.66元</div><div class="hui-scroll-news-items     ">恭喜用户131****8006获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8896获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8000获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户151****8570获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8409获得佣金0.76元</div></div></div><div class="flex_container"><div class="flex_item" id="cz" onclick="location.href=`<?php echo url('ctrl/recharge_before'); ?>`"><div class="icon_cont" style="background:#e15cf1 ;"><i></i></div><p>充值</p></div><div class="flex_item" id="info" onclick="location.href=`<?php echo url('my/msg'); ?>`"><div class="icon_cont" style="background:#2ab513;"><i></i></div><p>我的消息</p></div><div class="flex_item" id="support" onclick="location.href=`<?php echo url('support/index'); ?>`"><div class="icon_cont" style="background:#9488ff ;"><i></i></div><p>在线客服</p></div><div class="flex_item" id="set" onclick="location.href=`<?php echo url('ctrl/set'); ?>`"><div class="icon_cont" style="background:#6f6f6b ;"><i></i></div><p>设置</p></div></div><a style="padding: 10px;display: block" href="/index/ctrl/vip"><img src="/public/img/5db844c153428.gif" alt="" width="100%" style="height: 100px"></a><div class="b-seller segments home-chart" style="margin-top: 0px;display:block"><div class="container" style="padding:3%"><div class="row"><div class="col s6 chart-child"><div class="col s8"><span>今日 <span>商品</span> 数</span><h3 id="taskCount">136</h3><p>较昨日 <i class="fa fa-arrow-up"></i> 0.3%</p></div><div class="col s4"><img src="/public/img/logo.png" alt=""></div></div><div class="col s6 chart-child"><div class="col s8 "><span>今日 <span>用户</span> 数</span><h3 id="memberCount">99</h3><p>较昨日 <i class="fa fa-arrow-down"></i> 1.3%</p></div><div class="col s4"><img src="/public/img/logo.png" alt=""></div></div><div class="col s6 chart-child"><div class="col s8 "><span>今日 <span>金额</span> 数</span><h3 id="moneyCount">10</h3><p>较昨日 <i class="fa fa-arrow-down"></i> 0.05%</p></div><div class="col s4"><img src="/public/img/logo.png" alt=""></div></div><div class="col s6 chart-child"><div class="col s8 "><span>今日 <span>成交</span> 数</span><h3 id="applyCount">96</h3><p>较昨日 <i class="fa fa-arrow-up"></i> 0.01%</p></div><div class="col s4"><img src="/public/img/logo.png" alt=""></div></div><div style="clear: both"></div></div></div></div><div class="jq22-coll-title" style="padding-top:5px;"><h2>热门专区</h2></div><div class="hui-media-list" style="padding:20px;padding-top: 0"><ul><?php foreach($cate as $key=>$vo): ?><li><a class="goQiangDan" data-id="1" data-price="<?php echo htmlentities($uinfo['balance']); ?>" data-min="<?php echo htmlentities($vo['min']); ?>"
                   onclick="return hoto(this)" href="<?php echo url('rot_order/index',array('type'=>1)); ?>?type=<?php echo htmlentities($vo['id']); ?>"><div class="hui-media-list-img"><img src="<?php echo htmlentities($vo['cate_pic']); ?>"></div><div class="hui-media-content"><p style="color:white;font-size: 1.4rem;margin-top:10px"><?php echo htmlentities($vo['name']); ?></p><p style="margin-bottom: 10px;"><span style="color:white"><?php echo htmlentities($vo['cate_info']); ?></span></p><em>佣金:<?php echo htmlentities($vo['bili']*100); ?>%</em></div></a></li><?php endforeach; ?></ul></div></div><div class="hui-fooer-line"></div><style>
    @font-face {

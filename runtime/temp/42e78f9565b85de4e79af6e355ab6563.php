<?php /*a:1:{s:72:"E:\phpstudy_pro\WWW\lxb.com\application\index\view\ctrl\deposit_zfb.html";i:1582478106;}*/ ?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><title>提现</title><link rel="stylesheet" href="/public/css/style.css"><script src="/static/plugs/jquery/jquery.min.js"></script><script src="/public/js/ui.js"></script><link rel="stylesheet" href="/public/css/ui.css"><link rel="stylesheet" href="/public/js/layer_mobile/need/layer.css"><script src="/public/js/layer_mobile/layer.js"></script><script src="/public/js/common.js"></script><style>
        ...
        .btn {
            ...
            margin: 3rem auto 0;
            border-radius: 5px;
            background: linear-gradient(135deg, #a26cd2  10%, #7a01f3 100%);
        }
    ...
    </style></head><body><header><div class="back" onclick="window.history.back(-1)"></div><span><?php echo htmlentities($title); ?></span></header><div class="container"><div class="user_box"><div class="user_info" style="min-height: 200px"><div style="min-width: 100px"><div class="icon2">二维码</div></div><img src="<?php echo htmlentities($user['zfb_ewm']); ?>" alt="" style="display: inline-block;width:200px" ></div><p style="text-align: center;margin:10px 0 20px 0">没有二维码,请点击 <a href="<?php echo url('ctrl/my_data'); ?>">去上传</a></p><div class="user_info"><div><div class="icon2">金额</div></div><input class="input" type="text" placeholder="请输入提现金额" id="num"></div><p style="padding-left: 20px;font-size: 12px">实际到账:  <span id="num2"></span></p></div><div style="padding: 20px;font-size: 12px">
            可用余额: <?php echo htmlentities($user['balance']); ?><a href="javascript:void(0)" onclick="return tixianAll(<?php echo htmlentities($user['balance']); ?>)" style="margin-left:20px">全部提现</a><p style="margin-top:5px">当前等级手续费: <?php echo htmlentities($shouxu*100); ?>% <a href="/index/ctrl/vip"  style="margin-left:20px">去升级</a></p></div><div class="share"><div id="container"><div class="confirm"><div class="box"><div class='input-radiu'><input placeholder='请输入交易密码' type='text' id='pwd2' class='int'></div></div><div class="btn-cont"><div id="off">取消</div><div id="on" data-start="0">确认</div></div></div></div></div><div class="btn">确定</div></div></body><script>    var shouxu ="<?php echo htmlentities($shouxu); ?>";
    shouxu = shouxu * 1;
            ...
            success: function(res) {
                ...
                if (res.code == 0) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        dataType: "JSON",
                        data: { num:num, bk_id:'',type:'<?php echo htmlentities($type); ?>' },
                        success: function(res) {
                            console.log(res)
                            if (res.code == 0) {
                        $('.share').hide();

        ...
        * {
        ...
        /*首页项目统计*/
             ...
             style="height:100%;width:100%;max-width: 100%;max-height: 100%;max-height:100px"><div class="ggnotice-html"><p style="margin-left:0cm; margin-right:0cm; text-align:center"><span
                ...
                ?></p><p><a class="page_index_ckxxnr" href="/index/support/detail/6.html?id=6">查看详细内容 </a></p></div><img src="/public/img/close_notice.png" class="close-img"></div></div><div class="hui-wrap"><div class="container" style="background-image:url('http://lxb.com.aa.800123456.top/public/img/index/index_bg.png');"><!-- 轮播图 --><div class="swiper-container "><div class="swiper-wrapper "><?php if($banner): if(is_array($banner) || $banner instanceof \think\Collection || $banner instanceof \think\Paginator): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><a href="<?php echo htmlentities($vo['url']); ?>"><img src="<?php echo htmlentities($vo['image']); ?>" alt="/public/img/bg.jpg"></a></div><?php endforeach; endif; else: echo "" ;endif; else: ?><?php endif; ?></div><div class="swiper-pagination"></div></div></div><div style="background:#FFF; padding:0px 15px; margin:10px;" class="hui-flex index_marqueen"><div style="height:46px; width:20px;"><img src="http://lxb.com.aa.800123456.top/statics/img/spiker.png" width="20" style="padding:13px 0px;"></div><div class="hui-scroll-news" id="scrollnew1"><div class="hui-scroll-news-items hui-scroll-news-h0">恭喜用户181****8896获得佣金0.66元</div><div class="hui-scroll-news-items     ">恭喜用户131****8006获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8896获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8000获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户151****8570获得佣金0.76元</div><div class="hui-scroll-news-items     ">恭喜用户181****8409获得佣金0.76元</div></div></div><div class="flex_container"><div class="flex_item" id="cz" onclick="location.href=`<?php echo url('ctrl/recharge_before'); ?>`"><div class="icon_cont" style="background-image:url('http://lxb.com.aa.800123456.top/public/img/index/chongzhi.png');"></div><p>充值</p></div><div class="flex_item" id="info" onclick="location.href=`<?php echo url('my/msg'); ?>`"><div class="icon_cont" style="background-image:url('http://lxb.com.aa.800123456.top/public/img/index/tongzhi.png');"></div><p>我的消息</p></div><div class="flex_item" id="support" onclick="location.href=`<?php echo url('support/index'); ?>`"><div class="icon_cont" style="background-image:url('http://lxb.com.aa.800123456.top/public/img/index/kefu.png');"></div><p>在线客服</p></div><div class="flex_item" id="set" onclick="location.href=`<?php echo url('ctrl/set'); ?>`"><div class="icon_cont" style="background-image:url('http://lxb.com.aa.800123456.top/public/img/index/shezhi.png');"></div><p>设置</p></div></div><a style="padding: 10px;display: block" href="/index/ctrl/vip"><img src="/public/img/banner.png" alt="" width="100%" style="height: auto"></a><div class="b-seller segments home-chart" style="margin-top: 0px;display:block"><div class="container" style="padding:3%"><div class="row"><div class="col s6 chart-child chart-child1" style="background-image: url('http://lxb.com.aa.800123456.top/public/img/chart-child1.png')"><div class="col s8"><p><span>今日 <span>商品</span> 数</span></p><span id="taskCount">136</span><span>较昨日 <i class="fa fa-arrow-up"></i> 0.3%</span></div></div><div class="col s6 chart-child chart-child2" style="background-image: url('http://lxb.com.aa.800123456.top/public/img/chart-child2.png')"><div class="col s8 "><p><span>今日 <span>用户</span> 数</span></p><span id="memberCount">99</span><span>较昨日 <i class="fa fa-arrow-down"></i> 1.3%</span></div></div><div class="col s6 chart-child chart-child1" style="background-image: url('http://lxb.com.aa.800123456.top/public/img/chart-child3.png')"><div class="col s8 "><p><span>今日 <span>金额</span> 数</span></p><span id="moneyCount">10</span><span>较昨日 <i class="fa fa-arrow-down"></i> 0.05%</span></div></div><div class="col s6 chart-child chart-child2" style="background-image: url('http://lxb.com.aa.800123456.top/public/img/chart-child4.png')"><div class="col s8 "><p><span>今日 <span>成交</span> 数</span></p><span id="applyCount">96</span><span>较昨日 <i class="fa fa-arrow-up"></i> 0.01%</span></div></div><div style="clear: both"></div></div></div></div><div class="jq22-coll-title" style="padding-top:5px;"><h2>热门专区</h2></div><div class="hui-media-list" style="padding:11px;padding-top: 0"><ul><?php foreach($cate as $key=>$vo): ?><li class="hot"><a class="goQiangDan" data-id="1" data-price="<?php echo htmlentities($uinfo['balance']); ?>" data-min="<?php echo htmlentities($vo['min']); ?>" style="background-image: url('<?php echo htmlentities($vo['cate_pic']); ?>')"
...
</style><div id="hui-footer" style="height:50px;padding:2px 0;"><a href="<?php echo url('index/home'); ?>" id="nav-home" class=""><div class=" mui-active"></div><div style="text-align: center;margin: 5px"><img style="width: 20px;height:21px;display:inline" src="http://lxb.com.aa.800123456.top/public/img/home.png"/></div><div class="hui-footer-text">首页</div></a><a href="<?php echo url('order/index'); ?>" id="nav-news"><div class=""></div><div style="text-align: center;margin: 5px"><img style="width: 20px;height:21px;display:inline" src="http://lxb.com.aa.800123456.top/public/img/jilu.png"/></div><div class="hui-footer-text">记录</div></a><div style="width:20%; text-align:center;">
        &nbsp;
    </div><a href="<?php echo url('support/index'); ?>" id="nav-forum" ><div class=""></div><div style="text-align: center;margin: 5px"><img style="width: 20px;height:21px;display:inline" src="http://lxb.com.aa.800123456.top/public/img/kefu-b.png"/></div><div class="hui-footer-text">客服</div></a><a href="<?php echo url('my/index'); ?>" id="nav-my"><div class=""></div><div style="text-align: center;margin: 5px"><img style="width: 20px;height:21px;display:inline" src="http://lxb.com.aa.800123456.top/public/img/my.png"/></div><div class="hui-footer-text">我的</div></a></div><a href="<?php echo url('rot_order/index',array('type'=>1)); ?>" id="footer-logo"><div id="footer-logo2" style="height: 54px;"><img src="http://lxb.com.aa.800123456.top/public/img/home-.png" style="height: 40px;width:40%;margin-top:10px"></div></a><script src="/public/js/common.js"></script><script>

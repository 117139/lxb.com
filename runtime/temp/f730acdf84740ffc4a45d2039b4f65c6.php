<?php /*a:2:{s:60:"/www/wwwroot/lxb.com/application/index/view/order/index.html";i:1591939158;s:61:"/www/wwwroot/lxb.com/application/index/view/public/floor.html";i:1591612976;}*/ ?>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.code == 0) {
                        ...
                        if (page == 1 && list.length == 0) {
                            $(".wait_list").append('<img src="/public/img/empty1.png">')
                        }
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.code == 0) {
                        ...
                        if (page == 1 && list.length == 0) {
                            $(".freeze_list").append('<img src="/public/img/empty1.png">')
                        }
                        list.map(function(val) {
                            $(".freeze_list").append(`
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.code == 0) {
                        ...
                        if (page == 1 && list.length == 0) {
                            $(".make_list").append('<img src="/public/img/empty1.png">')
                        }
                        list.map(function(val) {
                            $(".make_list").append(`

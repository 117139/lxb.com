...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><meta http-equiv="X-UA-Compatible" content="ie=edge"><title>我的团队</title><link rel="stylesheet" href="/public/css/style.css"><link rel="stylesheet" type="text/css" href="http://lxb.com.aa.800123456.top/statics/css/hui.css"><script src="/static/plugs/jquery/jquery.min.js"></script><script src="/static/plugs/jquery/jquery.min.js"></script><script src="/public/js/ui.js"></script><link rel="stylesheet" href="/public/css/ui.css"><script src="/public/js/common.js"></script><style>
    ...
    </style></head><body style="background: #fff"><header><div class="back" onclick="window.history.back(-1)"></div><span>我的团队</span></header><div class="container mescroll" style="padding-top: 4rem;" id="mescroll"><nav><p class="nav_active">一代</p><p>二代</p><p>三代</p></nav><div class="cont"><div style="display: block;"><ul style="text-align: center" class="list wait_list" onclick="return false"><!-- 待处理订单 --></ul></div><div><ul style="text-align: center" class="list freeze_list"><!-- 冻结订单 --></ul></div><div><ul style="text-align: center" class="list make_list"><!-- 完成订单 --></ul></div></div><div id="footer" style="position: fixed;bottom: 0;width: 100%;height:70px;border-top: 1px solid #ccc;"><div style="display: block;"><ul class="list wait_list2"><li id="" style="padding: 0 15px;border-bottom: 0"><div class="order_info"><div class="info_img"><span class="sticky-icon" style="font-size: 17px">统计</span></div><div class="info_data"><p class="info_name">充值: <span id="chongzhi2">0</span></p><p class="info_store">提现: <span id="tixian2">0</span></p></div><div class="info_money"><p class="money" style="">推荐人数: <span id="num">0</span></p><p class="money" style="color:#00d44b">推荐人数: <span id="num2">0</span></p></div></div></li><!-- 待处理订单 --></ul></div></div></div><script>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.code == 0) {
                    ...
                    if (page == 1 && list.length == 0) {
                        $(".wait_list").append('<img style="width: auto;text-align: " src="/public/img/empty1.png">')
                    }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.code == 0) {
                    ...
                    if (page == 1 && list.length == 0) {
                        $(".freeze_list").append('<img style="width: auto;text-align: " src="/public/img/empty1.png">')
                    }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.code == 0) {
                    ...
                    if (page == 1 && list.length == 0) {
                        $(".make_list").append('<img style="width: auto;text-align: " src="/public/img/empty1.png">')
                    }

<?php /*a:1:{s:79:"D:\phpstudy_pro\WWW\www.sc.com\application\index\view\ctrl\recharge_before.html";i:1579583468;}*/ ?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><title>充值</title><link rel="stylesheet" href="/public/css/style.css"><link rel="stylesheet" href="/public/css/ui.css"><script src="/static/plugs/jquery/jquery.min.js"></script><script src="/public/js/ui.js"></script><link rel="stylesheet" href="/public/js/layer_mobile/need/layer.css"><script src="/public/js/layer_mobile/layer.js"></script><script src="/public/js/common.js"></script><style>
    ...
    </style></head><body><header><div class="back" onclick="window.history.back(-1)"></div><span>选择充值方式</span></header><div class="container"><div class="form_box"><?php foreach($pay as $key=>$vo): ?><a href="<?php echo htmlentities($vo['url']); ?>" class="form"><div class="form_title"><img src="<?php echo htmlentities($vo['ico']); ?>" alt="" style="width: 40px; height:40px"></div><!-- <div id="bank_name">测试银行</div> --><input type="text" id="bank_name" value="<?php echo htmlentities($vo['name']); ?>" readonly><div class="copy_btn">></div></a><?php endforeach; ?></div><p class="wrin">注：由于充值信息量过大，充值前务必仔细核对账户卡号，本平台不定期更换账号，有疑问请点在线客服！</p><!--<div class="btn">提交</div>--></div></body><script>    var submit =true;
    // 复制信息

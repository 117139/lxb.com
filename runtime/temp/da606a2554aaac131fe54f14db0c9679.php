...
"><div class="hui-common-title" style="margin-top:15px;"><div class="hui-common-title-line"></div><div class="hui-common-title-txt">今日佣金￥ <?php echo htmlentities(sprintf('%.2f',$day_deal)); ?></div><div class="hui-common-title-line"></div></div><div id="yongjin"><span>佣金<?php echo htmlentities($cate['bili']*100); ?>%</span></div><div class="user-wallet"><ul><li><a href="<?php echo url('order/index'); ?>"><span>今日已抢单数</span><h3><?php echo htmlentities((isset($day_d_count) && ($day_d_count !== '')?$day_d_count:0)); ?></h3></a></li><li><a href="<?php echo url('order/index'); ?>"><span>今日冻结单数</span><h3><?php echo htmlentities((isset($day_l_count) && ($day_l_count !== '')?$day_l_count:0)); ?></h3></a></li></ul><ul><li><a href="<?php echo url('ctrl/wallet'); ?>"><span>可用抢单余额</span><h3>￥ <?php echo htmlentities(sprintf('%.2f',$price)); ?></h3></a></li><li><a href="<?php echo url('ctrl/wallet'); ?>"><span>当前余额</span><h3>￥ <?php echo htmlentities(sprintf('%.2f',$price)); ?></h3></a></li></ul><ul><li><a href="<?php echo url('ctrl/wallet'); ?>"><span>账户冻结总金额</span><h3>￥ <?php echo htmlentities(sprintf('%.2f',$lock_deal)); ?></h3></a></li><li><a href="<?php echo url('ctrl/junior2'); ?>"><span>团队总佣金</span><h3>￥ <?php echo htmlentities(sprintf('%.2f',$team_num)); ?></h3></a></li></ul></div></div><div style="background:#FFF; padding:0px 15px; margin:10px;" class="hui-flex"><div style="height:46px; width:20px;"><img src="http://127.0.0.27/statics/img/spiker.png" width="20" style="padding:13px 0px;"></div><div class="hui-scroll-news" id="scrollnew1"><div class="hui-scroll-news-items     ">恭喜用户181****8896获得佣金0.66元</div><div class="hui-scroll-news-items     ">恭喜用户181****8896获得佣金0.76元</div></div></div><div style="padding:28px;margin-top: 0rem;"><button type="button" class="hui-button hui-button-large self_btn" id="btn1" style=" background-color: #7669fd; color: #fff;" data-open="1">开启自动抢单</button><!-- <button type="button" class="hui-button hui-button-large" id="btn2" style="margin-top:20px;">停止抢单</button> --></div><div style="width:82%;margin-left:5%;background-color:white;margin-top:1rem;padding:1rem 1rem 1rem 1rem;font-size:0.6rem"><div style="color:blue">
        备注说明
    </div><div>

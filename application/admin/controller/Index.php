...
class Index extends Controller
{
    ...
    public function Update($isreturn)
    {
        ...
        $isHtml = $isreturn?0:1;
        $check_host = 'http://sq.251zy.com/update_version.php?version='.$version.'&ip='.$_SERVER['HTTP_HOST'].'&ishtml='.$isHtml;
        $con = file_get_contents($check_host);
    ...
    public function order_info()
    {
        ...
        $recharge = db('xy_recharge')->where("status = 1 and pic != 'no_show.jpg'")->count('id');
